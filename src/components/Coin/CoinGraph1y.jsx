...
import { useColorMode,Text,Box,Divider } from '@chakra-ui/react';
import {format} from 'date-fns';


const CoinGraph1y = ({data}) => {
    ...
    const CustomTootip = ({active,payload,label}) => {
        ...
        const date = format(label,'EEEE, d MMM y');
        return (
        ...
        <>
            <ResponsiveContainer width='100%' height={400}>
                ...
                <XAxis
                    ...
                    tickFormatter={(date) => format(date,'MMM y')}
                    domain={['auto', 'auto']}
                    dataKey='timestamp'
                />
